...
class Authentication @Inject()(activate: Activate,
  ...
  def register(name: String, email: String, password: String): Future[(Int, UUID)] =
    this.register.execute(name, email, password)
