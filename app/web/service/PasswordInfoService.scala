...
import usecase.auth.{CreateIdentityByPassword, GetPasswordAuthInfo, GetPasswordAuthInfoByEmail, UpdatePassword}
import usecase.user.GetUserByEmail

import scala.concurrent.{ExecutionContext, Future}

class PasswordInfoService @Inject()(createAuthInfoByPassword: CreateIdentityByPassword,
